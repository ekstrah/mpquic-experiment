...
type Config struct {
	...
	// CongestionControlFactory constructs the congestion controller used for each connection.
	// If nil, defaults to Cubic.
	CongestionControlFactory ackhandler.CongestionControlFactory
